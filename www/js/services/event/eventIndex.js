...
angular.module('lapMobile.eventIndex', []).factory('EventIndex', function ($firebaseObject, $firebaseArray, FIREBASEURL) {
	var eventsRef = new Firebase(FIREBASEURL).child('ei');
